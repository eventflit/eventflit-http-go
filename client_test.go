...
func TestInitialisationFromURL(t *testing.T) {
	url := "http://feaf18a411d3cb9216ee:fec81108d90e1898e17a@service.eventflit.com/apps/104060"
	client, _ := ClientFromURL(url)
	expectedClient := &Client{Key: "feaf18a411d3cb9216ee", Secret: "fec81108d90e1898e17a", AppId: "104060", Host: "service.eventflit.com"}
	assert.Equal(t, expectedClient, client)
}

func TestURLInitErrorNoSecret(t *testing.T) {
	url := "http://fec81108d90e1898e17a@service.eventflit.com/apps"
...
func TestURLInitHTTPS(t *testing.T) {
	url := "https://key:secret@service.eventflit.com/apps/104060"
	client, _ := ClientFromURL(url)
...
func TestInitialisationFromENV(t *testing.T) {
	os.Setenv("EVENTFLIT_URL", "http://feaf18a411d3cb9216ee:fec81108d90e1898e17a@service.eventflit.com/apps/104060")
	client, _ := ClientFromEnv("EVENTFLIT_URL")
	expectedClient := &Client{Key: "feaf18a411d3cb9216ee", Secret: "fec81108d90e1898e17a", AppId: "104060", Host: "service.eventflit.com"}
	assert.Equal(t, expectedClient, client)
}
