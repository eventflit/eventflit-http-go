...
func TestClientWebhookValidation(t *testing.T) {
	...
	header["X-Eventflit-Key"] = []string{"key"}
	header["X-Eventflit-Signature"] = []string{"2677ad3e7c090b2fa2c0fb13020d66d5420879b8316eb356a2d60fb9073bc778"}
...
func TestWebhookImproperKeyCase(t *testing.T) {
	...
	badHeader["X-Eventflit-Key"] = []string{"narr you're going down!"}
	badHeader["X-Eventflit-Signature"] = []string{"2677ad3e7c090b2fa2c0fb13020d66d5420879b8316eb356a2d60fb9073bc778"}
...
func TestWebhookImproperSignatureCase(t *testing.T) {
	client := setUpClient()
	badHeader := make(http.Header)
	badHeader["X-Eventflit-Key"] = []string{"key"}
	badHeader["X-Eventflit-Signature"] = []string{"2677ad3e7c090i'mgonnagetyaeb356a2d60fb9073bc778"}
	badBody := []byte("{\"hello\":\"world\"}")
