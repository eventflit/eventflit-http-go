...
of your Eventflit channels. When used with a server, you can validate Eventflit
webhooks and authenticate private- or presence-channels.

In order to use this library, you need to have a free account
on http://eventflit.com. After registering, you will need the application
credentials for your app.

Getting Started

To create a new client, simply pass in your application credentials to a `eventflit.Client` struct:
...
authenticating private- and presence-channels, validating Eventflit webhooks,
and querying the HTTP API to get information about your channels.

Author: Jamie Patel, Eventflit
